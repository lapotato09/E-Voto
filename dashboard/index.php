...
<html>
  <head>
    ...
    <link rel="stylesheet" href="global/sidebar/sidebar.css">
  ...
  <body class="ffam-sig">    
    <div class="container-fluid">
      ...
      <div class="row">
        <div id="app2" class="d-none d-lg-block col-lg-2" style="margin-top: -50px; padding-top: 10px;">
  ...
  <footer>
    <script type="text/javascript" src="dashboard/DashboardApp.php"></script>
    ...
    <script>
      // const rootApp = angular.module('RootApp',['DashboardApp','SidebarApp']);

      angular.bootstrap(document.querySelector('#app1'),['DashboardApp']);
      angular.bootstrap(document.querySelector('#app2'),['SidebarApp']);
    </script>
    <!-- <div>   <?php include '../global/footer.php'?>    </div> -->
  </footer>
</html>
