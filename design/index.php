...
<html>
  <head>
    ...
    ?>
    <title> E-Voto | Data Design</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="../lib/custom/design-tpl.css">
  ...
  <body class="ffam-sig">  
   ...
   <footer>
    ...
    <script type="text/javascript" src="design/DesignApp.php"></script>
    ...
    <script>
      angular.bootstrap(document.querySelector('#app1'),['DesignApp']);
