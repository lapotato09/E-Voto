...
<html>
  <head>
    ...
    <title> E-Voto | Canvassing Overview</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <footer>
    <script type="text/javascript" src="canvassing/overview/CanvassingOverviewApp.php"></script>
    ...
    <script>
      angular.bootstrap(document.querySelector('#app1'),['CanvassingOverviewApp']);
