...
<html>
  <head>
    ...
    <title> E-Voto | Canvassing Process</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <footer>
    <script type="text/javascript" src="canvassing/processing/CanvassingProcessingApp.php"></script>
    ...
    <script>
      angular.bootstrap(document.querySelector('#app1'),['CanvassingProcessingApp']);
