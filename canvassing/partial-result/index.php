...
<html>
  <head>
    ...
    <title> E-Voto | Initial Result</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <footer>
    <script type="text/javascript" src="canvassing/partial-result/CanvassingPartialResultApp.php"></script>
    ...
    <script>
      angular.bootstrap(document.querySelector('#app1'),['CanvassingPartialResultApp']);
