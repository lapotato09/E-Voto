...
<head>
	...
	?>
	<title>E-Voto | Candidacy Evaluation</title>
  <!-- meta tags -->
  <meta charset="utf-8">
...
<footer>
  <script type="text/javascript" src="candidacy/evaluation/CandidacyEvaluationApp.php"></script>
  ...
  <script>
    angular.bootstrap(document.querySelector('#app1'), ['CandidacyEvaluationApp']);
