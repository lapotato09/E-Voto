...
<head>
  ...
  ?>
  <title>E-Voto | Candidacy Inventory </title>
  <!-- Required Meta tags -->
  <meta charset="utf-8">
...
<footer>
  <script type="text/javascript" src="candidacy/inventory/CandidacyInventoryApp.php"></script>
  ...
  <script>
    angular.bootstrap(document.querySelector('#app1'), ['CandidacyInventoryApp']);
